...
public class MetaInput {
  ...
  public MetaInput name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public MetaInput mnemonic(String mnemonic) {
    this.mnemonic = mnemonic;
    return this;
  }

   /**
   * Meta Mnemonic (SEDOL, TICKER, CURRENCY, QES_GSECTOR, QES_GGROUP, QES_COUNTRY)
   * @return mnemonic
  **/
  @ApiModelProperty(value = "Meta Mnemonic (SEDOL, TICKER, CURRENCY, QES_GSECTOR, QES_GGROUP, QES_COUNTRY)")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.name, metaInput.name) &&
        Objects.equals(this.mnemonic, metaInput.mnemonic);
  }
